...
impl From<&ImageSpec> for String {
    fn from(image_spec: &ImageSpec) -> Self {
        // https://docs.rs/prost/0.8.0/prost/trait.Message.html#method.encode_to_vec
        // encode_to_vec 将 ImageSpec 序列化为字节数组 由 prost::Message 提供的 trait
